...
$product->table_name = "oc_product_special";

// запрос данных
$stmt = $product->readAll($from_record_num, $records_per_page);
$num = $stmt->rowCount();

$page_title = "Таблица Oc_product_special";
...
$page_url = "toc_product_special.php?";
