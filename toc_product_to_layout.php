...
$product->table_name = "oc_product_to_layout";

// запрос данных
$stmt = $product->readAll($from_record_num, $records_per_page);
$num = $stmt->rowCount();

$page_title = "Таблица Oc_product_to_layout";
...
$page_url = "toc_product_to_layout.php?";
